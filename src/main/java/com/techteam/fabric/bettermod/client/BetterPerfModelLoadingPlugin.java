...
public final class BetterPerfModelLoadingPlugin implements ModelLoadingPlugin {
	private static final ModelIdentifier ROOM_CONTROLLER_BLOCK_MODEL_ID = new ModelIdentifier(Identifier.of("betterperf", "block/room_controller"), "");
	private static final ModelIdentifier ROOM_CONTROLLER_ITEM_MODEL_ID = new ModelIdentifier(Identifier.of("betterperf", "item/room_controller"), "");
	...
	public void onInitializeModelLoader(@NotNull Context pluginContext) {
		...
		pluginContext.modifyModelOnLoad().register((original, context) -> {
			...
			if(context.topLevelId().equals(ROOM_CONTROLLER_BLOCK_MODEL_ID) || context.topLevelId().equals(ROOM_CONTROLLER_ITEM_MODEL_ID)) {
